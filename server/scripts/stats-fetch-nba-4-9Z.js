...
// Game IDs to fetch
const gameIds = [12265, 12266, 12267, 12268, 12269, 12270, 12271, 12272, 12273, 12274];
...
async function fetchAllPlayerStats() {
    ...
    try {
        ...
        // Save to file
        const outputPath = path.join(__dirname, '..', 'raw_api', 'raw-stats-4-9Z.json');
        const outputData = {
            metadata: {
...
// Run the script
console.log('Starting to fetch player statistics for 10 games...');
