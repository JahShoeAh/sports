...
const finalVenueMapping = () => {
  return new Promise((resolve, reject) => {
    console.log('Starting final venue mapping...');
        ...
        .on('end', () => {
          ...
          db.all(`SELECT id, game_date, home_team_id, away_team_id FROM games`, (err, games) => {
            ...
            setTimeout(() => {
              ...
              console.log(`\n📊 Final Venue Mapping Summary:`);
              console.log(`- Updated ${updatedGames} games`);
              console.log(`- Not found ${notFoundGames} games`);
              console.log('🎉 Final venue mapping completed successfully!');
              resolve();
            }, 3000);
          });
        })
...
if (require.main === module) {
  finalVenueMapping()
    ...
    .catch((error) => {
      console.error('Final venue mapping failed:', error);
      db.close();
      process.exit(1);
    });
}

module.exports = { finalVenueMapping };
