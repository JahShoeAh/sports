...
const transformPlayer = (player) => ({
  ...
  heightFormatted: formatHeight(player.height_inches),
  weightLbs: player.weight_lbs,
  weightFormatted: formatWeight(player.weight_lbs),
  nationality: player.nationality,
  photoUrl: player.photo_url,
  injuryStatus: player.injury_status,
  draftYear: player.draft_year,
  draftPickOverall: player.draft_pick_overall,
